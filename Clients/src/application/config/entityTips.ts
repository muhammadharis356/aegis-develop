...
export const ENTITY_TIPS: EntityTips = {
  ...
  settings: [
    {
      header: "Settings customize Aegis.AI to your organization's needs.",
    ...
    {
      header: "Integration settings connect Aegis.AI to your existing tools.",
      content: "If your organization uses other systems for task management, documentation, or communication, integration settings can connect them to Aegis.AI. These connections reduce duplicate data entry and keep information synchronized across platforms.",
    },
  ],
  "evals-overview": [
    {
