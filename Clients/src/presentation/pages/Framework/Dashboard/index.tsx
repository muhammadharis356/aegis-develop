...
const FRAMEWORK_SELECTED_KEY = "aegis_framework_selected";
const ISO27001_TAB_KEY = "aegis_iso27001_tab";
const ISO42001_TAB_KEY = "aegis_iso42001_tab";
const NIST_AI_RMF_TAB_KEY = "aegis_nist_ai_rmf_tab";
...
const DASHBOARD_TAB_STORAGE_KEY = "aegis_dashboard_active_tab";
