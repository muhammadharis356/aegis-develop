  ...
  return (
    <Stack sx={{ mt: 3, width: "100%" }}>
        ...
        >
          <Box>
            ...
            <Typography sx={{ fontSize: 13, color: "#666666", mt: 0.5, mb: 3 }}>
              Manage your LLM keys for access to Aegis.AI Advisor.
            </Typography>
          </Box>
          {keys.length > 0 && (
            <CustomizableButton
        ...
        {isLoading && keys.length === 0 ? (
          ...
          >
            ...
            <Typography sx={{ fontSize: 13, color: "#666666", mb: 3 }}>
              Add your first LLM API key to enable access to your Aegis.AI
              Advisor.
            </Typography>
            <CustomizableButton
              text="Add API key"
      ...
      <StandardModal
        ...
        description={
          isCreateModalOpen
            ? "Connect your LLM provider to enable Aegis.AI Advisor."
