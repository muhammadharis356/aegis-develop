  ...
  return (
    <Stack spacing={4} alignItems="center">
      ...
      >
        ...
        >
          Aegis.AI is your AI governance and compliance platform. In 3 minutes, we'll help you get started with managing AI risks, compliance frameworks, and building trust.
        </Typography>
        <Typography
          sx={{
            fontSize: "14px",
