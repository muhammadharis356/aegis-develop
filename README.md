[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Aegis-AI/Aegis.AI)
![](https://img.shields.io/github/repo-size/Aegis-AI/Aegis.AI)
![](https://img.shields.io/github/commit-activity/m/Aegis-AI/Aegis.AI)
![](https://img.shields.io/github/last-commit/Aegis-AI/Aegis.AI)
![](https://img.shields.io/github/languages/top/Aegis-AI/Aegis.AI)
![](https://img.shields.io/github/issues/Aegis-AI/Aegis.AI)
![](https://img.shields.io/github/issues-pr/Aegis-AI/Aegis.AI)



[Aegis.AI](https://Aegis.AI.ai) is a source available AI governance platform designed to help businesses use the power of AI safely and responsibly. Our platform ensures compliance and robust AI management without compromising on security.
...
- [Need to talk to someone](https://Aegis.AI.ai/contact)? Get with us to see the latest demo, or [click here](https://app.Aegis.AI.ai) to experience the demo yourself.
- [Read our documentation](https://Aegis.AI.ai/user-guide/) to understand features and capabilities
...
The Aegis.AI application has two components: a frontend built with React.js and a backend built with Node.js. At present, you can use `npm` (for development) or Docker/Kubernetes (production) to run Aegis.AI. A PostgreSQL database is required.
...
First, clone the repository to your local machine and go to Aegis.AI directory. Then, navigate to the Clients directory and install the dependencies:
...
Access the PostgreSQL container and create the Aegis.AI database:

```
docker exec -it mypostgres psql -U postgres
CREATE DATABASE Aegis.AI;
```
...
```
curl -O https://raw.githubusercontent.com/Aegis-AI/Aegis.AI/develop/install.sh
curl -O https://raw.githubusercontent.com/Aegis-AI/Aegis.AI/develop/.env.prod
```
...
3. Create a config file (`/etc/nginx/sites-available/Aegis.AI`) with the following content. Change the domain name accordingly.
...
```
sudo mkdir -p /var/www/Aegis.AI
sudo curl -o /var/www/Aegis.AI/upgrade.html https://raw.githubusercontent.com/Aegis-AI/Aegis.AI/develop/Clients/upgrade.html
```

5. Enable the config:

```
sudo ln -s /etc/nginx/sites-available/Aegis.AI /etc/nginx/sites-enabled/
sudo nginx -t
...
Aegis.AI supports multiple email service providers through a provider abstraction layer, enabling administrators to choose the most suitable email service for their organization. The system includes security enhancements such as TLS enforcement, input validation and credential rotation for supported providers.

Below is a list of supported email providers. You can use [this documentation](https://Aegis.AI.ai/user-guide/settings/email-configuration) to setup the email service of your choice.
...
You’ll need to open ports 80 and 443 so Aegis.AI can be accessed from the internet.

## Security

If you find a vulnerability, please report it [here](https://github.com/Aegis-AI/Aegis.AI/security/advisories/new).
