...
export async function runAdvisor(req: Request, res: Response) {
  ...
  logStructured(
    "processing",
    "Getting Aegis.AI advisor response",
    functionName,
    fileName,
  );
  logger.debug(" Getting Aegis.AI advisor response");
  ...
  try {
    ...
    logStructured(
      "successful",
      "Getting Aegis.AI advisor response successful",
      functionName,
      fileName,
    );
    ...
    logStructured(
      "error",
      "failed to get Aegis.AI advisor response",
      functionName,
      fileName,
    );
    logger.error("❌ Error in getting Aegis.AI advisor response:", error);
