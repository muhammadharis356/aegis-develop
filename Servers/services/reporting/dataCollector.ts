 ...
 * Following Aegis.AI clean architecture patterns
 */
...
export class ReportDataCollector {
  ...
  private async collectBranding(): Promise<ReportBranding> {
    ...
    return {
      organizationName,
      organizationLogo,
      primaryColor: "#13715B", // Aegis.AI green
