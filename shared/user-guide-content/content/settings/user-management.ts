...
export const userManagementContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'User management in Aegis.AI allows administrators to control who has access to the platform and what they can do. From the Settings page, you can manage your own profile, update security credentials, and administer team members.',
    },
    {
      type: 'heading',
      id: 'settings-tabs',
