...
export const notificationsContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI provides notification capabilities to keep you informed about important governance activities. Notifications help ensure that team members are aware of updates, deadlines, and actions that require attention.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI can notify you about various governance events:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'The primary way to receive notifications from Aegis.AI is through the Slack integration. When configured, Aegis.AI can send real-time notifications directly to your Slack workspace.',
    },
    {
      type: 'paragraph',
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Authorize Aegis.AI to connect to your Slack workspace' },
    ...
    {
      type: 'paragraph',
      text: 'In addition to external notifications, Aegis.AI displays visual indicators within the platform to highlight items needing attention:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    },
    {
      ...
      level: 3,
      text: 'Does Aegis.AI send email notifications?',
    },
    {
      type: 'paragraph',
      text: 'Currently, Aegis.AI uses Slack as the primary notification channel. Email is used for account-related communications like invitations and password resets, but not for governance notifications.',
    },
    {
      type: 'heading',
