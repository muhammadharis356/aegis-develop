...
export const roleConfigurationContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI uses role-based access control (RBAC) to manage what users can see and do within the platform. Each user is assigned a role that determines their permissions across all features.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI provides three predefined roles to cover common organizational needs:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Administrators have complete control over the Aegis.AI platform. This role should be assigned to users responsible for platform governance and user management.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Currently, Aegis.AI provides three predefined roles (Admin, Editor, Viewer). Custom role configuration is not available in this version. The predefined roles cover most organizational needs.',
    },
    {
      type: 'heading',
