...
export const organizationSettingsContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Organization settings allow you to configure your organization\'s identity and branding within Aegis.AI. These settings define how your organization appears across the platform and in generated reports.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'The organization name identifies your company or team across Aegis.AI. It appears in reports, documentation, and throughout the platform.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Upload your organization\'s logo to brand your Aegis.AI instance. The logo appears in various places throughout the platform.',
    },
    {
      type: 'heading',
      id: 'uploading-logo',
    ...
    {
      type: 'paragraph',
      text: 'When you first log in to Aegis.AI, you may be prompted to set your organization name if it has not been configured. This ensures your governance documentation and reports display the correct organization identifier from the start.',
    },
    {
      type: 'heading',
      id: 'faq',
    ...
    {
      type: 'paragraph',
      text: 'The organization logo is used for branding within the Aegis.AI platform. Report formatting depends on the specific report type and may or may not include the logo.',
    },
    {
      type: 'heading',
      id: 'faq-who-can-edit',
