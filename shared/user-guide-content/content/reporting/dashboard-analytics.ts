...
export const dashboardAnalyticsContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'The Aegis.AI dashboard is the first screen you see after logging in. It provides a real-time overview of your AI governance program, showing key metrics across all areas of the platform in a customizable layout.',
    },
    {
      type: 'paragraph',
    ...
    },
    {
      ...
      alt: 'Aegis.AI dashboard showing widget cards with status charts for models, vendors, policies, trainings, and incidents',
      caption: 'The Aegis.AI dashboard provides an at-a-glance view of your AI governance program.',
    },
    {
      type: 'heading',
      id: 'greeting',
    ...
    {
      type: 'paragraph',
      text: 'When you first log in to Aegis.AI, you may be prompted to confirm or update your organization name. This ensures your governance documentation and reports display the correct organization identifier.',
    },
    {
      type: 'heading',
      id: 'faq',
    ...
    {
      type: 'paragraph',
      text: 'To reset your dashboard, enter edit mode and use the "Show/hide cards" selector to hide all widgets. Then click the link to restore all cards, which resets them to the default layout. Alternatively, you can clear your browser\'s local storage for the Aegis.AI site.',
    },
    {
      type: 'heading',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Get started with Aegis.AI',
        },
      ],
    },
  ],
