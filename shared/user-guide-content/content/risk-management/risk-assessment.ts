...
export const riskAssessmentContent: ArticleContent = {
  blocks: [
    ...
    },
    {
      type: 'callout',
      variant: 'info',
      text: 'Risks in Aegis.AI can be linked to both use cases and compliance frameworks, allowing you to track risks across different contexts and regulatory requirements.',
    },
    {
      type: 'image',
    ...
    {
      type: 'paragraph',
      text: 'To create a new risk in Aegis.AI, navigate to the Risk Management section and provide the following information:',
    },
    {
      type: 'ordered-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI tracks risks across the complete AI system lifecycle:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Each risk is analyzed using likelihood and severity assessments. Aegis.AI automatically calculates the overall risk level based on these inputs.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'Based on likelihood and severity, Aegis.AI automatically calculates the risk level:',
    },
    {
      type: 'table',
      columns: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI provides several views for monitoring your risks:',
    },
    {
      type: 'bullet-list',
      items: [
