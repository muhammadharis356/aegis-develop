...
export const riskMitigationContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI tracks multiple risk level measurements to show mitigation effectiveness:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'For significant risks, Aegis.AI supports an approval process:',
    },
    {
      type: 'ordered-list',
      items: [
