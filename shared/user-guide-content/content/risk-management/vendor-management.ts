...
export const vendorManagementContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI includes a built-in review workflow for vendor assessments:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI uses a scorecard approach to assess vendor risk. Each vendor is evaluated across multiple dimensions:',
    },
    {
      type: 'heading',
      id: 'data-sensitivity',
    ...
    {
      type: 'paragraph',
      text: 'Based on the scorecard inputs, Aegis.AI calculates an overall risk score for each vendor. Higher scores indicate greater risk requiring more attention and oversight.',
    },
    {
      type: 'callout',
      variant: 'tip',
