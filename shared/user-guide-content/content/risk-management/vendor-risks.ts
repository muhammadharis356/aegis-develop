...
export const vendorRisksContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI assesses vendor risk across four key dimensions:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI calculates an overall risk score based on the scorecard inputs. Higher scores indicate greater risk. Factors that increase the score include:',
    },
    {
      type: 'bullet-list',
      items: [
