...
export const assessmentsContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI supports multiple compliance frameworks to help you meet regulatory requirements and demonstrate responsible AI governance. Each framework provides a structured approach to evaluating your AI systems against specific standards or regulations.',
    },
    {
      type: 'paragraph',
      text: 'Rather than treating compliance as a one-time event, Aegis.AI enables continuous assessment and improvement. You can track progress over time, identify gaps, and demonstrate to auditors exactly where you stand on each requirement.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI includes support for the following compliance frameworks:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'To begin compliance tracking in Aegis.AI:',
    },
    {
      type: 'ordered-list',
      items: [
        ...
        { text: 'Aegis.AI creates an assessment with all applicable requirements' },
    ...
    {
      type: 'paragraph',
      text: 'While each framework has its own structure and terminology, they share common elements in Aegis.AI:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Compliance is not a one-time achievement. Aegis.AI supports ongoing compliance management:',
    },
    {
      type: 'bullet-list',
      items: [
