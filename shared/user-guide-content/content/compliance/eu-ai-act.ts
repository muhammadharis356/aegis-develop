...
export const euAiActContent: ArticleContent = {
  blocks: [
    ...
    },
    {
      ...
      id: 'Aegis.AI-support',
      level: 2,
      text: 'How Aegis.AI supports EU AI Act compliance',
    },
    {
      type: 'paragraph',
      text: 'Aegis.AI provides structured tools to help you meet EU AI Act requirements:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'To begin your EU AI Act compliance journey in Aegis.AI:',
    },
    {
      type: 'ordered-list',
      items: [
        { text: 'Create a use case for your AI system in Aegis.AI' },
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI organizes EU AI Act requirements into manageable controls and subcontrols:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'When you select the EU AI Act framework for a use case, Aegis.AI creates an assessment containing all applicable controls. The assessment screen provides a comprehensive view of your compliance progress.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'EU AI Act controls in Aegis.AI are organized into categories aligned with the regulation\'s structure:',
    },
    {
      type: 'checklist',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI provides multiple ways to monitor your EU AI Act compliance progress:',
    },
    {
      type: 'bullet-list',
      items: [
