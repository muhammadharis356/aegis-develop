...
export const iso42001Content: ArticleContent = {
  blocks: [
    ...
    },
    {
      ...
      id: 'Aegis.AI-support',
      level: 2,
      text: 'How Aegis.AI supports ISO 42001',
    },
    {
      type: 'paragraph',
      text: 'Aegis.AI helps you build and demonstrate an ISO 42001-compliant AI management system:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'When you select ISO 42001 for a use case, Aegis.AI creates an assessment with two distinct sections that mirror the structure of the standard:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'For each subclause, Aegis.AI tracks:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI provides metrics to monitor your ISO 42001 compliance progress:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Start by understanding your AI system context, establishing an AI policy, assessing risks and impacts, and securing leadership commitment. Then plan, support, operate, monitor, and continually improve your AI management system. Aegis.AI provides tools to support each phase of implementation.',
    },
    {
      type: 'article-links',
