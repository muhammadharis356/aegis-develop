...
export const nistAiRmfContent: ArticleContent = {
  blocks: [
    ...
    },
    {
      ...
      id: 'Aegis.AI-support',
      level: 2,
      text: 'How Aegis.AI supports NIST AI RMF',
    },
    {
      type: 'paragraph',
      text: 'Aegis.AI provides a structured environment to implement and track your NIST AI RMF activities. The platform organizes the framework into functions, categories, and subcategories, making it easy to work through requirements systematically.',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    },
    {
      ...
      variant: 'tip',
      title: 'Best practice',
      text: 'Use the NIST AI RMF Playbook alongside Aegis.AI. The Playbook provides specific suggested actions for each subcategory that you can track in Aegis.AI. Download the Playbook from the official NIST website.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI organizes the NIST AI RMF into a three-level hierarchy that mirrors the framework\'s structure:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'When you access NIST AI RMF in Aegis.AI, you see the four core functions with their categories and subcategories. Each function shows progress indicators so you can quickly see where you stand:',
    },
    {
      type: 'checklist',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'For each subcategory, Aegis.AI tracks:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI provides multiple ways to monitor your NIST AI RMF implementation:',
    },
    {
      type: 'bullet-list',
      items: [
