...
export const dashboardContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: "The dashboard is your home base in Aegis.AI. After logging in, this is the first screen you'll see — it provides a snapshot of your AI governance program across all projects and lets you quickly access the areas that need attention.",
    },
    {
      type: 'paragraph',
      text: 'You can return to the dashboard at any time by clicking the Aegis.AI logo in the top-left corner or selecting "Dashboard" from the sidebar menu.',
    },
    {
      type: 'callout',
      variant: 'info',
