...
export const quickStartContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: "This guide walks you through setting up your first AI governance use case in Aegis.AI. By the end, you'll have a working use case with a compliance framework, controls to track, and your first piece of evidence uploaded.",
    },
    {
      type: 'checklist',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Use cases in Aegis.AI represent individual AI systems that you want to govern. Each use case has its own compliance tracking, risk assessments, and evidence collection.',
    },
    {
      type: 'ordered-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Compliance frameworks define the requirements you need to meet. Aegis.AI comes with several built-in frameworks that you can apply to your use case.',
    },
    {
      type: 'grid-cards',
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        { bold: '', text: 'Aegis.AI will automatically populate the required controls and assessments' },
      ],
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: "Controls are the specific requirements you need to implement. When you add a framework, Aegis.AI creates a set of controls based on that framework's requirements.",
    },
    {
      type: 'ordered-list',
      items: [
    ...
    },
    {
      ...
      text: "AI governance is an ongoing process. Aegis.AI helps you track progress over time, so don't feel pressured to complete everything at once. Focus on one area at a time and build from there.",
    },
  ],
};
