  ...
  blocks: [
    {
      ...
      id: 'what-is-Aegis.AI',
      level: 2,
      text: 'What is Aegis.AI?',
    },
    {
      type: 'paragraph',
      text: "Aegis.AI is an enterprise-ready AI governance platform that helps organizations manage AI systems safely and responsibly. Whether you're tracking AI models, managing compliance with regulations like the EU AI Act, or monitoring vendor risks, Aegis.AI provides the tools you need to bring order to your AI governance program.",
    },
    {
      type: 'paragraph',
    ...
    },
    {
      type: 'callout',
      variant: 'info',
      text: 'Aegis.AI is source-available software, which means you can review the code, deploy it internally, and maintain full visibility into how your governance platform operates.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: "Aegis.AI centralizes your AI governance activities in one platform. Here's what you can accomplish:",
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI provides built-in support for major AI governance and information security frameworks:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Beyond core governance capabilities, Aegis.AI includes features designed to streamline your workflow:',
    },
    {
      type: 'checklist',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI is designed for flexible deployment to match your infrastructure requirements:',
    },
    {
      type: 'grid-cards',
      items: [
    ...
    },
    {
      type: 'ordered-list',
      items: [
        { bold: 'Install Aegis.AI', text: '— Follow our installation guide to deploy the platform in your environment' },
