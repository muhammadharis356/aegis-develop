...
export const installingContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI can be deployed on your own infrastructure, giving you complete control over your data. Before starting the installation, make sure you have the following prerequisites in place.',
    },
    {
      type: 'requirements',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI supports two deployment approaches depending on your needs:',
    },
    {
      type: 'grid-cards',
      columns: 2,
    ...
    {
      type: 'paragraph',
      text: 'The production setup uses Docker Compose to run all services in containers. This is the simplest way to get Aegis.AI running.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'code',
      code: `mkdir Aegis.AI && cd Aegis.AI
...
./install.sh`,
    ...
    {
      type: 'paragraph',
      text: 'The script will pull the Docker images, create the database, and start all services. Once complete, Aegis.AI will be available at your configured `FRONTEND_URL`.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'code',
      code: `git clone https://github.com/Aegis-AI/Aegis.AI.git
cd Aegis.AI
...
# Create the database
docker exec -it mypostgres psql -U postgres -c "CREATE DATABASE Aegis.AI;"`,
    },
    {
      type: 'heading',
      id: 'dev-step-3',
...
cd Clients && npm run dev`,
    ...
    },
    {
      ...
      rows: [
        ...
        { variable: 'POSTGRES_DB', description: 'Database name (default: Aegis.AI)' },
    ...
    {
      type: 'paragraph',
      text: "When you first access Aegis.AI, you'll see the admin registration page. This is expected — the platform ships without any default users for security reasons.",
    },
    {
      type: 'ordered-list',
      items: [
        { text: 'Navigate to your Aegis.AI URL in a web browser' },
    ...
    },
    {
      ...
      variant: 'warning',
      title: 'Important',
      text: 'Complete the admin registration promptly after deployment. Anyone with access to your Aegis.AI URL can register as admin until the first account is created.',
    },
    {
      type: 'heading',
      id: 'ssl-security',
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Configure Nginx to proxy requests to Aegis.AI services' },
    ...
    },
    {
      ...
      variant: 'tip',
      title: 'Next step',
      text: 'Now that Aegis.AI is installed, learn how to navigate the dashboard and set up your first AI governance use case.',
    },
  ],
};
