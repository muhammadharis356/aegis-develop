...
export const policyApprovalContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI includes a library of pre-built policy templates covering common AI governance topics. These templates provide a starting point for creating your own organizational policies, saving time and ensuring you address key governance areas.',
    },
    {
      type: 'paragraph',
