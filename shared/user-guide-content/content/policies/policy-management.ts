...
export const policyManagementContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'The Policy Manager in Aegis.AI helps you create, organize, and maintain AI governance policies for your organization. Well-documented policies are the foundation of effective AI governance, demonstrating your commitment to responsible AI and ensuring consistent practices across teams.',
    },
    {
      type: 'paragraph',
      text: 'Policies in Aegis.AI can be created from scratch or built from pre-designed templates covering common AI governance topics. Each policy tracks its status through a defined lifecycle, from initial draft through review and approval to publication.',
    },
    {
      type: 'heading',
      id: 'why-policies',
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI provides predefined tags to help categorize your policies:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Yes. You can paste existing policy content into Aegis.AI to centralize your AI governance documentation. Many organizations start by importing their current policies, then use Aegis.AI to track their status, schedule reviews, and maintain a single source of truth for AI governance.',
    },
    {
      type: 'heading',
