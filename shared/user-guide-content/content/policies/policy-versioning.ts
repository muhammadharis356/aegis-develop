...
export const policyVersioningContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Policies in Aegis.AI follow a defined lifecycle from initial creation through publication and eventual retirement. Understanding this lifecycle helps you manage policies effectively and ensures stakeholders always know which policies are active and authoritative.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI automatically tracks who made changes and when:',
    },
    {
      type: 'bullet-list',
      items: [
