...
export const integrationOverviewContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI integrations connect your AI governance platform with external tools and services. Integrations help streamline workflows, automate data synchronization, and keep your team informed through familiar channels.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI currently offers the following integrations:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'The Slack integration enables Aegis.AI to send notifications directly to your Slack workspace. You can route different types of notifications to specific channels, keeping your team informed about governance activities without leaving Slack.',
    },
    {
      type: 'paragraph',
      text: 'Key features:',
    ...
    {
      type: 'paragraph',
      text: 'The MLflow integration connects Aegis.AI to your MLflow tracking server, enabling automatic synchronization of machine learning models. This helps maintain an up-to-date model inventory without manual data entry.',
    },
    {
      type: 'paragraph',
      text: 'Key features:',
    ...
    {
      type: 'paragraph',
      text: 'In addition to pre-built integrations, Aegis.AI provides API access for custom integrations. API keys allow you to programmatically interact with Aegis.AI data and features from external applications or scripts.',
    },
    {
      type: 'paragraph',
