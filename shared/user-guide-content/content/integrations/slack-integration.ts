...
export const slackIntegrationContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'The Slack integration enables Aegis.AI to send real-time notifications about AI governance activities directly to your Slack workspace. Keep your team informed about model updates, risk assessments, compliance changes, and more without leaving Slack.',
    },
    {
      type: 'heading',
      id: 'what-you-can-do',
    ...
    },
    {
      ...
      items: [
        ...
        { bold: 'Stay informed', text: 'Keep your team updated without requiring them to log into Aegis.AI' },
      ],
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'To connect your Slack workspace to Aegis.AI:',
    },
    {
      type: 'ordered-list',
      items: [
        ...
        { text: 'You will be redirected back to Aegis.AI with the connection active' },
      ],
    },
    {
      type: 'callout',
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI requests the following Slack permissions:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'These permissions allow Aegis.AI to send notifications but do not give access to read your messages or user data.',
    },
    {
      type: 'heading',
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Ensure the Aegis.AI app has not been removed from your Slack workspace' },
    ...
    {
      type: 'paragraph',
      text: 'Yes, if you grant the appropriate permissions during authorization. The Aegis.AI Slack app will need to be invited to private channels to send messages there.',
    },
    {
      type: 'heading',
      id: 'faq-who-sees',
    ...
    {
      type: 'paragraph',
      text: 'Notifications are sent in real-time as events occur in Aegis.AI. There is no batching or delay.',
    },
    {
      type: 'article-links',
