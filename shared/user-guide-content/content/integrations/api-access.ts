...
export const apiAccessContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI provides API access for programmatic integration with external applications, scripts, and automation workflows. API keys allow authenticated access to Aegis.AI features without requiring interactive login.',
    },
    {
      type: 'paragraph',
      text: 'Use API keys to build custom integrations, automate data synchronization, or connect Aegis.AI with your existing tools and processes.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'API keys provide access to Aegis.AI API endpoints based on the permissions available to your organization. The specific endpoints and operations available are documented in the API reference.',
    },
    {
      type: 'heading',
      id: 'faq-rate-limits',
