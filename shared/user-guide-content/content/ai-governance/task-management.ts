...
export const taskManagementContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Task management in Aegis.AI helps you coordinate AI governance activities and compliance tasks across your teams. From implementation milestones to audit preparation, the task system ensures accountability and visibility into your governance program.',
    },
    {
      type: 'paragraph',
