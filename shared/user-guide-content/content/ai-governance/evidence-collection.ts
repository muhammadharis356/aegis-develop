...
export const evidenceCollectionContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI supports various file formats for evidence documentation. Each uploaded file tracks:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Evidence in Aegis.AI can be organized by the compliance requirement it supports. This helps you quickly identify:',
    },
    {
      type: 'checklist',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Beyond the Evidence Hub, Aegis.AI allows you to attach evidence directly to compliance assessments. This creates a clear link between specific assessment questions and the documentation that demonstrates compliance.',
    },
    {
      type: 'paragraph',
