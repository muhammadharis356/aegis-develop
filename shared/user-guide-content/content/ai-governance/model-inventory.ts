...
export const modelInventoryContent: ArticleContent = {
  blocks: [
    ...
    },
    {
      type: 'callout',
      variant: 'info',
      text: 'Maintaining an accurate model inventory is a core requirement for EU AI Act compliance and ISO 42001 certification. Aegis.AI automatically tracks changes to your inventory for audit purposes.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'For organizations using MLFlow for ML operations, Aegis.AI can import model training data directly. This provides visibility into model development metrics including training timestamps, parameters, and lifecycle stages.',
    },
    {
      type: 'heading',
      id: 'change-history',
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI automatically maintains a complete audit trail for every model in your inventory. Each change records:',
    },
    {
      type: 'bullet-list',
      items: [
