...
export const watchtowerContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Event Tracker gives you a live window into Aegis.AI. It records every user action and system event, then lets you dive into the raw logs for deeper troubleshooting. Use it to see who did what, spot patterns, and keep your application running smoothly.',
    },
    {
      type: 'paragraph',
