...
export const modelLifecycleContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI recognizes the following phases in the AI model lifecycle, aligned with industry standards and regulatory expectations:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Each AI project in Aegis.AI has a status that indicates its current state in the governance workflow:',
    },
    {
      type: 'table',
      columns: [
    ...
    {
      type: 'paragraph',
      text: 'For teams using MLFlow, Aegis.AI imports lifecycle stage information directly from your ML platform:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Aegis.AI supports EU AI Act risk classification for projects, which influences governance requirements throughout the lifecycle:',
    },
    {
      type: 'grid-cards',
      columns: 2,
    ...
    {
      type: 'paragraph',
      text: 'For high-risk AI systems, Aegis.AI tracks your organization\'s role in the AI value chain, as different roles carry different compliance obligations:',
    },
    {
      type: 'bullet-list',
      items: [
