...
export const trainingTrackingContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'The Training Registry in Aegis.AI helps you track AI-related training programs across your organization. Maintaining a record of training activities demonstrates that your team has the knowledge and skills needed to develop, deploy, and govern AI systems responsibly.',
    },
    {
      type: 'paragraph',
