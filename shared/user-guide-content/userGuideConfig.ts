...
export const collections: Collection[] = [
  {
    ...
    description: 'Learn the basics of Aegis.AI and get up and running quickly with your AI governance journey.',
    icon: 'Rocket',
    articleCount: 4,
    articles: [
      {
        ...
        description: 'An introduction to the Aegis.AI platform and its core capabilities.',
        keywords: ['welcome', 'introduction', 'overview', 'platform'],
      },
      {
        id: 'installing',
        title: 'Installing Aegis.AI',
        description: 'Step-by-step guide to deploy Aegis.AI in your environment.',
  ...
  },
  {
    id: 'integrations',
    title: 'Integrations',
    description: 'Connect Aegis.AI with your existing tools and workflows.',
    icon: 'Plug',
    articleCount: 3,
    articles: [
      {
  ...
  },
  {
    ...
    description: 'Configure Aegis.AI to match your organization\'s needs.',
    icon: 'Settings',
    articleCount: 4,
    articles: [
      {
